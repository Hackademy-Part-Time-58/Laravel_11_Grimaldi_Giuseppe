<div class="col-md-4">
    <div class="card position-relative" >
        ...
        <p class="position-absolute bottom-0 end-0 text-muted">{{$item->user->name}}</p>
        <span class="badge position-absolute top-0 end-0 mt-1 me-1 px-4"style="{{$item->category->color}}">{{$item->category->name}}</span>
